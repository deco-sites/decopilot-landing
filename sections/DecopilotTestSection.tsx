...
export default function DecopilotSection({
  ...
  const description =
    "Decopilot is an AI-powered code generation tool that helps developers write better code faster.";
  ...
  const faqItems = [
    ...
    },
    {
      ...
      answer:
        "Decopilot uses advanced machine learning algorithms to analyze your code and suggest improvements and optimizations.",
    },
  ];
      ...
      <div class="container mx-auto px-4">
        ...
        {includeFAQ && (
          <div class="card bg-base-100 shadow-xl">
            <div class="card-body">
              <h3 class="card-title text-2xl font-bold mb-4 text-accent">
                {faqTitle}
              </h3>
